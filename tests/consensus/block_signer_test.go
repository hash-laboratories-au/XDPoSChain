...
func TestNotChangeSingerListIfNothingProposedOrVoted(t *testing.T) {
	...
	block, err := insertBlock(blockchain, 450, blockCoinBase, parentBlock, merkleRoot, nil)
	if err != nil {
		t.Fatal(err)
	}
	parentSigners, err := GetSnapshotSigner(blockchain, parentBlock.Header())
...
func TestUpdateSignerListIfVotedBeforeGap(t *testing.T) {
	...
	merkleRoot = "46234e9cd7e85a267f7f0435b15256a794a2f6d65cc98cdbd21dcd10a01d9772"
	block450, err := insertBlock(blockchain, 450, block450CoinbaseAddress, parentBlock, merkleRoot, nil)
	if err != nil {
		t.Fatal(err)
	}
...
func TestCallUpdateM1WhenForkedBlockBackToMainChain(t *testing.T) {
	...
	merkleRoot = "068dfa09d7b4093441c0cc4d9807a71bc586f6101c072d939b214c21cd136eb3"
	block451B, err := insertBlock(blockchain, 451, blockCoinBase451B, block450B, merkleRoot, nil)
...
func TestVoteShouldNotBeAffectedByFork(t *testing.T) {
	...
	merkleRoot := "35999dded35e8db12de7e6c1471eb9670c162eec616ecebbaf4fddd4676fb930"
	block450A, err := insertBlock(blockchain, 450, blockCoinBase450A, parentBlock, merkleRoot, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	blockCoinBase450B := "0xbbb0000000000000000000000000000000000450"
	merkleRoot = "35999dded35e8db12de7e6c1471eb9670c162eec616ecebbaf4fddd4676fb930"
	block450B, err := insertBlock(blockchain, 450, blockCoinBase450B, parentBlock, merkleRoot, nil)
	if err != nil {
		t.Fatal(err)
	}
	...
	merkleRoot = "35999dded35e8db12de7e6c1471eb9670c162eec616ecebbaf4fddd4676fb930"
	block452B, err := insertBlock(blockchain, 452, blockCoinBase452B, block451B, merkleRoot, nil)
	if err != nil {
		t.Fatal(err)
	}
