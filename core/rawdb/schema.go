...
// freezerNoSnappy configures whether compression is disabled for the ancient
// tables. Hashes and difficulties don't compress well due to their small or
// already-random nature, so they're stored raw.
